...
#include"atten_serial.h"

unsigned char RegisterData[4] = {0,0,0,0};

unsigned char pe4302data=0;
...
//	WriteToAD9959ViaSpi(0x04,4,RegisterData);//Output frequency = 10MHz
	...
	//RegisterData[1] = 0x30;//bit[12:11] 10:manual 11:auto

	//RegisterData[0] = 0x4d;//bit[10:0] amplitude
